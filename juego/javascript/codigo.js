...
come.style.top="190px"
come.style.left="170px"
come.style.transform = "rotate(180deg)"

var fan=new Array(4)
for (i=1;i<=4;i++){
fan[i]=new Image()
fan[i].style.position="absolute"
//fan[i].style.top="265px"
fan[i].style.top="190px"
fan[i].src = "imagenes/FAN"+i+"11.png"
//fan[i].style.left=188+(i-1)*25+"px"
fan[i].style.left=220+(i-1)*25+i*5+"px"
}
...
function cargarvariables(){   
	...
	velox[0]=1
	veloy[0]=0
	come.style.transform = "rotate(0deg)"
	dire[0]=1
	come.style.visibility = "hidden";
	for (i=1;i<=4;i++){fan[i].style.visibility = "hidden";}
...
function juegonuevo(){
	...
	cuentacome=0
	velocidadfan=4
	come.style.visibility="visible"
	for (i=1;i<=4;i++){fan[i].style.visibility="visible"}
...
ponecome()
come.style.visibility="visible"
for(i=1;i<=4;i++){ponefan(i);fan[i].style.visibility="visible"}
for(i=1;i<=6;i++){
	fruta[i].style.visibility="hidden";
	fruta[i].style.top="300px";
	fruta[i].style.left="35px"
...
if (dire[b]==controlrota){return}
	switch (dire[b]){
    	case 1:
    	come.style.transform = "rotate(0deg)";controlrota=dire[b]
    	break;
 		case 2:
    	come.style.transform = "rotate(90deg)";controlrota=dire[b]
    	break;
 		case 3:
    	come.style.transform = "rotate(180deg)";controlrota=dire[b]
    	break;
 		case 4:
    	come.style.transform = "rotate(270deg)";controlrota=dire[b]
    	break;
	}
}
...
function ponecome(){
come.style.position="absolute"
come.style.top=posiy[0]+"px"
come.style.left=posix[0]+"px"
}

function flascome(){
if (controlflas==1){come.src = "imagenes/COMEA.png";controlflas=0}
else {come.src = "imagenes/COMEB.png";controlflas=1}
}
...
function ponefan(a){
fan[a].style.position="absolute"
fan[a].style.top=posiy[a]+"px"
fan[a].style.left=posix[a]+"px"
}
...
function flasfan(){
	for (i=1;i<=4;i++){
		switch (situ[i]){
    		case 0:
    		if (controlflasfan[i]==1){fan[i].src = "imagenes/FAN"+i+dire[i]+"1.png";controlflasfan[i]=0}
			else {fan[i].src = "imagenes/FAN"+i+dire[i]+"2.png";controlflasfan[i]=1}
    		break;
 			case 1:
    		if (controlflasfan[i]==1){fan[i].src = "imagenes/FAN"+i+dire[i]+"1.png";controlflasfan[i]=0}
			else {fan[i].src = "imagenes/FAN"+i+dire[i]+"2.png";controlflasfan[i]=1}
    		break;
 			case 2:
    		if (controlflasfan[i]==1){fan[i].src = "imagenes/FAN5"+dire[i]+"1.png";controlflasfan[i]=0}
			else {fan[i].src = "imagenes/FAN5"+dire[i]+"2.png";controlflasfan[i]=1}
    		break;
 			case 3:
    		if (controlflasfan[i]==1){fan[i].src = "imagenes/FAN5"+dire[i]+"1.png";controlflasfan[i]=0}
			else {fan[i].src = "imagenes/FAN6"+dire[i]+"2.png";controlflasfan[i]=1}
 			break;
 			case 4:
    		if (controlflasfan[i]==1){fan[i].src = "imagenes/FAN7"+dire[i]+"1.png";controlflasfan[i]=0}
			else {fan[i].src = "imagenes/FAN7"+dire[i]+"2.png";controlflasfan[i]=1}
			break;
			case 5:
			if (controlflasfan[i]==1){fan[i].src = "imagenes/FAN7"+dire[i]+"1.png";controlflasfan[i]=0}
			else {fan[i].src = "imagenes/FAN7"+dire[i]+"2.png";controlflasfan[i]=1}
...
var f=new Array(22)
	...
	for (i=1;i<=4;i++){miformulario.appendChild(fan[i]);}
	miformulario.appendChild(come);
